...
The concept of heat rate / conversion efficiency adds some complexity to the earlier statement that U.S. electricity consumption of ~4100 TWh / 14.8 EJ represents 14% of U.S. total energy usage.  Because electricity is generated by power plants with less than 100% efficiency, **more than 14.8 EJ** of fuel input is required to generate that electricity.  The EIA reports that [36.7 quadrillion BTU](https://www.eia.gov/energyexplained/us-energy-facts/), or $$(36.7 \times 10^{15}\ BTU) \times {3.6\ EJ \over 3.4 \times 10^{15}\ BTU} = 38.7\ EJ$$ of fuel energy inputs is consumed to generate this electricity.
