...
- The U.S. generates and consumes [about 4,100 TWh](https://www.eia.gov/energyexplained/electricity/electricity-in-the-us-generation-capacity-and-sales.php) of electricity per year.   A terawatt hour is one billion kWh, so this is $$(4,100 \times 10^9 kWh) \times (3.6 \times 10^6 J / kWh) = 1.48 \times 10^{19} J$$.  $$10^{18}$$ gets a prefix "exa", so this is 14.8 exajoules (14.8 EJ).   This is a relatively small share (2.5%) of global energy consumption
- The U.S. total energy consumption is [98 quadrillion BTU](https://www.eia.gov/energyexplained/us-energy-facts/data-and-statistics.php), or $$(98 \times 10^15 BTU) \times {3.6\ EJ \over 3.4 \times 10^15 BTU) = 103.8\ EJ$$.  
- So electricity consumption is a modest fraction (~14%) of total energy consumption in the U.S.
...
The concept of heat rate / conversion efficiency adds some complexity to the earlier statement that U.S. electricity consumption of ~4100 TWh / 14.8 EJ represents 14% the U.S. total energy usage.  Because electricity is generated by power plants with less than 100% efficiency, **more than 14.8 EJ** of fuel input is required to generate that electricity.  The EIA reports that [36.7 quadrillion BTU](https://www.eia.gov/energyexplained/us-energy-facts/), or $${36.78 \times 10^15 BTU} \times {3.6 EJ \over 3.4 x 10^15 BTU} = 38.7 EJ$$ of fuel energy inputs is required to generate this power.

This means that the total energy inputs to generate electricity account for about 37% of the U.S.'s primary energy consumption of 103.8 EJ.  It also means that there is 23.8 EJ of thermal energy that is lost as waste heat in its conversion to useable electricity, about 23% of total energy conusmption.  [This](https://www.eia.gov/energyexplained/us-energy-facts/images/consumption-by-source-and-sector.png) is a nice chart demonstrating this concept. 
