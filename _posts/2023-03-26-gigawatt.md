...
<table>
    <tr class="blue">
        ...
        <th colspan="2" scope ="colgroup">Small Business (monthly usage < 3,500 kWh)</th> 
        <th colspan="2" scope ="colgroup">Medium Business (monthly usage > 3,500 kWh, demand < 299 kW)</th> 
    </tr>    
    <tr class="gray">
