...
$0 = cos\~\alpha\~cos\~\phi\~cos\~\theta - sin\~\alpha\~sin\~\phi$.   Dividing by $cos~\alpha$ to leave us with only a single $\alpha$ term and moving the second term to the left side: 
