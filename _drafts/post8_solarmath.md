...
Since $cos\~\alpha\ = \frac{1}{\sqrt{1 + tan^2\~\alpha}}$, we get $cos\~\alpha\ = \dfrac{1}{\sqrt{1 + \frac{cos^2\~\theta}{tan^2\~\phi}}} = \dfrac{tan \~\phi}{\sqrt{tan^2\~\phi + cos^2\~\theta}}$.   

Substituting this and our expression for $tan\~\alpha$ back into the $cos\~\beta$ equation, we get: 

$cos\~\beta = \dfrac{tan \~\phi}{\sqrt{tan^2\~\phi + cos^2\~\theta}} \times (\dfrac{cos^2\~\theta ~cos\~\phi\}{tan\~\phi} + ~sin\~\phi) = \dfrac{tan \~\phi}{\sqrt{tan^2\~\phi + cos^2\~\theta}} \times (\dfrac{cos^2\~\theta}{tan\~\phi} + tan\~\phi) \times cos\~\phi\ = \dfrac{tan \~\phi}{\sqrt{tan^2\~\phi + cos^2\~\theta}} \times (cos^2\~\theta + tan^2\~\phi) \times cos\~\phi\$.
